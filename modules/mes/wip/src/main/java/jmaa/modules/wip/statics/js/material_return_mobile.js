...
jmaa.view({
    ...
    loadOrder() {
        ...
        me.detailsList.load();
        if (me.orderForm.editors.print_flag.getRawValue()) {
            me.orderForm.editors.print_flag.setValue(me.orderForm.editors.print_flag.getRawValue())
        } else {
    ...
    onOrderFormLoad(e, form) {
        ...
        if ('draft' != form.editors.status.getRawValue()) {
            form.editors.work_order_id.readonly(true)
        }
    },
    loadLine() {
        let me = this;
